        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookedById = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fields_Teams_BookedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Practises_Fields_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Fields",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Practises_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ParticipantsId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PractisesId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PractiseUser", x => new { x.ParticipantsId, x.PractisesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PractiseUser_Practises_PractisesId",
                        column: x => x.PractisesId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "-1", "f0526591-df13-4ce3-b04d-8cef5f057881", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "-2", "c3829907-ff6b-4534-8dd3-015a3bccc574", "User", "USER" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "-1", new DateOnly(1, 1, 1), "ADMIN", "71d04902-b790-4361-9bce-989e1650aca0", "ADMIN", "ADMIN", "ADMIN", "ADMIN", "ADMIN", "AQAAAAEAACcQAAAAEDtOB5I6akZLSnLv0VBjejEEBKY+b74Z+iNIsLvgRS0lnAJDA0LF2AtTPfLHv3cwyA==", "ADMIN", "5f788fa7-3059-4ddc-8cb5-125fece85693", "ADMIN", null, "admin", "ADMIN" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fields_BookedById",
                table: "Fields",
                column: "BookedById");

            migrationBuilder.CreateIndex(
                name: "IX_Practises_LocationId",
                table: "Practises",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Practises_TeamId",
                table: "Practises",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_PractiseUser_PractisesId",
                table: "PractiseUser",
                column: "PractisesId");
        }
